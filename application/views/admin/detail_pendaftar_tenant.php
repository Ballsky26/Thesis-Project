            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="<?= base_url(''); ?>admin/pendaftar_tenant">Data Pendaftar Tenant</a></div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <a href="<?= base_url(''); ?>admin/pendaftar_tenant" class="btn btn-info float-right">Kembali</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
