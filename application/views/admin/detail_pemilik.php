            ...
            <div class="card">
                <div class="card-body">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer bg-inverse">
                                        <div class="row text-center">
                                            <div class="col">
                                                <span>Foto KTP :</span>
                                                <img class="img-fluid img-thumbnail" src="<?php echo base_url('assets/login/img/gambar/') . $pemilik['foto_ktp'];  ?>" alt="Foto KTP">
                                            </div>
                                            <div class="col">
                    ...
                    <a href="<?= base_url(''); ?>admin/pemilik_tenant" class="btn btn-info float-right">Kembali</a>
                </div>
            </div>