        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control" id="tanggal_daftar" name="tanggal_daftar" placeholder="Masukkan Nama Lengkap" value="<?= $peserta_pelatihan['tanggal_daftar']; ?>" readonly>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <a href="<?= base_url(''); ?>ketua/pendaftar_pelatihan" class="btn btn-primary">Kembali</a>
