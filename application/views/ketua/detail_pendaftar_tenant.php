            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="<?= base_url(''); ?>ketua/pendaftar_tenant">Data Pendaftar Tenant</a></div>
                    <div class="breadcrumb-item">Detail Pendaftar Tenant</div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <style>
                        ...
                        .widget-profile-card-3 {
                            background-image: url("<?php echo base_url('assets/login/img/pendaftar/') . $pendaftar['foto_profil']; ?>");
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-xl-4">
                                <div class="card">
                                    <div class="widget-profile-card-3">
                                        <img class="img-fluid img-thumbnail csa rounded-circle" src="<?php echo base_url('assets/login/img/pendaftar/') . $pendaftar['foto_profil']; ?>">
                                    </div>
                                        ...
                                        <div class="row text-center">
                                            <div class="col">
                                                ...
                                                if ($pendaftar['foto_ktp'] != null) { ?>
                                                    <img class="img-fluid img-thumbnail" src="<?php echo base_url('assets/login/img/pendaftar/') . $pendaftar['foto_ktp']; ?>">
                                                <?php
                                                } else {
                                                ?>
                                            ...
                                            <div class="col">
                                                ...
                                                if ($pendaftar['foto_produk'] != null) { ?>
                                                    <img class="img-fluid img-thumbnail" src="<?php echo base_url('assets/login/img/pendaftar/') . $pendaftar['foto_produk']; ?>">
                                                <?php
                                                } else {
                                                ?>
                                                    <i style="color: red;">*</i> <i>Tidak Ada Data</i><br>
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="chat-header text-muted"><?= $pendaftar['tanggal_lahir']; ?></p>
                                            </div>
                                        </div>
                                        <div class="media">
                                            <div class="media-left">
                                ...
                                <a href="<?= base_url(''); ?>ketua/pendaftar_tenant" class="btn btn-info float-right">Kembali</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
