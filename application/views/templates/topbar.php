...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                <img alt="image" src="<?= base_url('assets/login/img/avatar/') . $user['image']; ?>" class="rounded-circle mr-2">
                <div class="d-sm-none d-lg-inline-block"><?= $user['name']; ?></div>
            </a>

            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-divider"></div>
                <a href="<?= base_url(''); ?>auth/myprofile" class="dropdown-item has-icon">
                    <i class="fas fa-user"></i>My Profile
                </a>
                <a href="<?= base_url(''); ?>auth/edit_password" class="dropdown-item has-icon">
