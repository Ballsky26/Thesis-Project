<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item"><a href="<?= base_url(''); ?>pemilik/dashboard">Dashboard</a></div>
    </div>
</div>
<div class="card">
    <div class="card-body">
        <style>
            ...
            .widget-profile-card-3 {
                background-image: url("<?php echo base_url('assets/login/img/gambar/') . $pemilik['foto_produk']; ?>");
                        ...
                        <div class="card-footer bg-inverse">
                            <div class="row text-center">
                                <div class="col">
                                    <span>Foto KTP :</span>
                                    <?php
                                    if ($pemilik['foto_ktp'] != null) { ?>
                                        <img class="img-fluid img-thumbnail" src="<?php echo base_url('assets/login/img/gambar/') . $pemilik['foto_ktp']; ?>">
                                    <?php
                                    } else {
                                    ?>
                                ...
                                <div class="col">
                                    ...
                                    if ($pemilik['foto_produk'] != null) { ?>
                                        <img class="img-fluid img-thumbnail" src="<?php echo base_url('assets/login/img/gambar/') . $pemilik['foto_produk']; ?>" alt="Foto Produk">
                                    <?php
                                    } else {
                                    ?>
