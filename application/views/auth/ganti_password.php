            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 mt-3">
                        ...
                        <hr>
                        <p class="text-muted text-center">Ubah Password anda</p>
                        ...
                        <form class="user" method="POST" action="<?= base_url('auth/ganti_password'); ?>">
                            ...
                            <div class="form-group">
                                <label>Password</label>
                                <input type="password" class="form-control form-control-user" id="password2" name="password2" placeholder="Masukkan Kembali Password Baru">
