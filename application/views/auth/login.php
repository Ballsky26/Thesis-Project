            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 mt-3">
                        ...
                        <hr>
                        <p class="text-muted text-center">Silahkan mengisi email dan password. Jika berhasil login, lengkapi/update data anda sesuai dengan kondisi yang sebenarnya.</p>
                        ...
                        <form class="user" method="POST" action="<?= base_url('auth'); ?>">
                            ...
                            <div class="form-group">
                                <div class="d-block">
                                    ...
                                    <input type="password" class="form-control form-control-user" data-indicator="pwindicator" id="password" name="password" placeholder="Masukkan Password">
                                </div>
